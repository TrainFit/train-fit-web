...
const MorePage = () => {
  ...
  const downloadLinks = [
    {
      name: 'Google Play',
      url: 'https://play.google.com/store/apps/details?id=com.trainfit.trainfit',
      icon: google,
    ...
    {
      name: 'App Store',
      url: 'https://apps.apple.com/es/app/trainfit/id6471257280',
      icon: apple,
      className: 'app-store-btn',
      description: 'Disponible para iOS'
    }
  ];
  ...
  const socialLinks = [
    {
      ...
      description: 'Síguenos para tips diarios',
      icon: (
    ...
    {
      name: 'TikTok',
      url: 'https://www.tiktok.com/@trainfit.app?lang=es',
      className: 'tiktok-btn',
      description: 'Videos de entrenamientos',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 16 16">
 ...
 /*    {
      name: 'Facebook',
      url: 'https://www.facebook.com/AppTrainFit',
    ...
    {
      name: 'YouTube',
      url: 'https://www.youtube.com/@trainfit',
      className: 'youtube-btn',
      description: 'Tutoriales y entrenamientos',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 16 16">
  ...
  return (
    <div className="more-page">
      <Container>
        ...
        <Row className="mb-5">
          <Col lg={12}>
            <div className="section-header text-center mb-4" data-aos="fade-up">
              <h2 className="section-title">Descarga la App</h2>
              <p className="section-subtitle">
                Lleva tu entrenamiento al siguiente nivel con nuestra aplicación móvil
              </p>
            </div>
            <Row className="justify-content-center">
              {downloadLinks.map((link, index) => (
                <Col md={6} lg={4} key={index} className="mb-4">
                  <Card 
                    className={`download-card ${link.className}`} 
                    data-aos="fade-up" 
                    data-aos-delay={index * 100}
                  >
                    <Card.Body className="text-center">
                      <div className="download-icon mb-3">
                        <img src={link.icon} alt={link.name} className="store-icon" />
                      </div>
                      <h3 className="download-title">{link.name}</h3>
                      <p className="download-description">{link.description}</p>
                      <a
                        href={link.url}
                        target="_blank"
                ...
                <Col md={6} lg={3} key={index} className="mb-4">
                  ...
                  >
                    <Card.Body className="text-center">
                      ...
                      <h4 className="social-title">{social.name}</h4>
          ...
          <Col lg={12}>
            <div className="cta-section text-center" data-aos="fade-up">
              ...
              <p className="cta-subtitle">
                Únete a miles de usuarios que ya están alcanzando sus objetivos con TrainFit
              </p>
